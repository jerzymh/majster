function [] = QMFWithHighbandModDivide(inputFileName, lowbandFileName, highbandFileName)
...
len_high=length(u1)
pm=0:len_high-1;
u1mod=((-1).^pm').*u1;   % zmodulowany sygnal gornopasmowy

 wavwrite(u1mod,fe/2, highbandFileName);   % zapisujemy sygnal gornopasmowy jako sygnal 8000 pr/s
