...
class QMFWithHighbandModDivider(DividerBase):
    ...
    def divide(self, inputFileName):
        self.engine.QMFWithHighbandModDivide(inputFileName, self.lowBandFilename, self.highBandFilename, nargout=0)
    ...
    def merge(self, factors):
        ...
        self.engine.QMFWithHighbandModMerge(self.reconstructionFileName, factors[0], factors[1], nargout=0)
        return self.reconstructionFileName

    def __repr__(self):
        return "QMFWithHighbandModDivider"