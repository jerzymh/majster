function [] = QMFWithHighbandModMerge(reconstructionFileName, lowbandFileName, highbandFileName)
...
u1mod_=wavread(highbandFileName);

len_high=length(u1mod_)
pm=0:len_high-1;

u1_=((-1).^pm').*u1mod_;   % zdemodulowany sygnal gornopasmowy
d1=upsample(u1_,2);
y1=conv(d1,g1);
